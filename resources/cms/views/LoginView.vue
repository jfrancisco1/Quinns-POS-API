  ...
  <div class="min-h-screen bg-gradient-to-br from-brand-900 to-brand-700 flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-8">
      <div class="text-center mb-8">
        ...
        <h1 class="text-2xl font-bold text-gray-900">Superadmin CMS</h1>
      ...
      <form @submit.prevent="handleSubmit" class="space-y-4">
        <div>
          ...
          <input
            ...
            class="w-full px-3.5 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent transition"
        ...
        <button
          type="submit"
          :disabled="loading"
          class="w-full py-2.5 bg-brand-600 text-white rounded-lg text-sm font-semibold hover:bg-brand-700 disabled:opacity-50 transition-colors"
        >
