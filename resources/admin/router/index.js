...
const routes = [
    ...
    },
    {
        ...
        children: [
            ...
            { path: 'expense-categories', name: 'ExpenseCategories', component: () => import('../views/expense-categories/ExpenseCategoryListView.vue') },
            { path: 'expense-categories/create', name: 'ExpenseCategoryCreate', component: () => import('../views/expense-categories/ExpenseCategoryFormView.vue') },
            { path: 'expense-categories/:id/edit', name: 'ExpenseCategoryEdit', component: () => import('../views/expense-categories/ExpenseCategoryFormView.vue') },
